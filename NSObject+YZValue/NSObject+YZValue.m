...
#import "NSObject+YZValue.h"

@implementation NSObject (YZValue)
...
/***********************key+default***************************/
- (BOOL)booleanValueForKey:(NSString *)key
              defaultValue:(BOOL)defalutValue{
...
- (long)longValueForKey:(NSString *)key
           defaultValue:(long)defalutValue{
    id value = [self objectValueForKey:key];
...
- (long long)longLongValueForKey:(NSString *) key
                    defaultValue:(long long)defalutValue{
    id value = [self objectValueForKey:key];
...
- (float)floatValueForKey:(NSString *)key
             defaultValue:(float)defalutValue{
    id value = [self objectValueForKey:key];
...
- (double)doubleValueForKey:(NSString *)key
               defaultValue:(double)defalutValue{
    id value = [self objectValueForKey:key];
...
- (NSString *)stringValueForKey:(NSString *)key
                   defaultValue:(NSString *)defalutValue{
    id value = [self objectValueForKey:key];
    @try {
